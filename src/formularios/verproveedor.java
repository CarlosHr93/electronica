...
public class verproveedor extends javax.swing.JFrame {
 ...
 public void Escribir()
    {
        try{
     PreparedStatement pst = cn.prepareStatement("INSERT INTO `proveedor` (`idProveedor`, `nombre`, `apellido`, `telefono`, `direccion`, `correo`) VALUES (?,?,?,?,?,?)");
     pst.setString(1, jtid.getText());
     pst.setString(2, jtnombre.getText());
     pst.setString(3, jtapellido.getText());
     pst.setString(4, jttelefono.getText());
...
{
    String [] titulos= {"idproveedor", "nombre", "apellido", "direccion", "telefono", "correo"};
...
public void Actualizar()
{
     try {
            ...
            PreparedStatement pst = cn.prepareStatement("UPDATE proveedor set nombre=? , apellido=?, telefono=? ,direccion=?, correo=? where idProveedor=?" );
            ...
            pst.setString(5, jtcorreo.getText());
             pst.setString(6, dao);
...
public void EliminarDatos()
{
    try{
            int filaSeleccionada = tablaproveedor.getSelectedRow();
            String SQL = "delete from proveedor where idProveedor="+tablaproveedor.getValueAt(filaSeleccionada,0);
    ...
    private void initComponents() {
        ...
        jPanel1.add(jtdireccion, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 120, 169, -1));
        ...
        jPanel1.add(jttelefono, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 160, 169, -1));
        ...
        jPanel1.add(jtcorreo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 169, -1));
    ...
    private void tablaproveedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaproveedorMouseClicked
     ...
     jtid.setText(tablaproveedor.getValueAt(filaSeleccionada, 0).toString());
     jtnombre.setText(tablaproveedor.getValueAt(filaSeleccionada, 1).toString());
     jtapellido.setText(tablaproveedor.getValueAt(filaSeleccionada, 2).toString());
     jttelefono.setText(tablaproveedor.getValueAt(filaSeleccionada, 3).toString());
     jtdireccion.setText(tablaproveedor.getValueAt(filaSeleccionada, 4).toString());
     jtcorreo.setText(tablaproveedor.getValueAt(filaSeleccionada, 4).toString());
